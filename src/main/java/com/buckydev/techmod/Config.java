...
@EventBusSubscriber(modid = TechMod.MODID, bus = EventBusSubscriber.Bus.MOD)
public class Config {
    ...
    static final ModConfigSpec SPEC = BUILDER.build(); // This line needs to be last
    ...
    static void onLoad(final ModConfigEvent event) {
        TechMod.LOGGER.debug("config::onLoad");
